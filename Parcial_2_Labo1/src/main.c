...
int main()
{
    ...
    do{
    	if(utnGetNumero(&opcion,
    			...
    			"Opcion 11: Pasajeros por clase: \n"
    			"Opcion 12: Generar archivo de vuelos:\n"
				...
				MAXIMOOPCION, REINTENTOS)==RETORNOPOSITIVO)
    	{
			...
			{
			case 1://Carga .csv
				if(menu_cargaDatosPasajerosDesdeCsv("C:\\Registros\\Archivos\\data.csv",listaPasajeros)==RETORNOPOSITIVO && flagCarga == -1)
				{
			...
			case 3://Alta manual
				...
				{
					puts("Debe cargar datos antes de poder dar de alta algo\n");
				}
			...
			case 4://
				...
				{
					puts("Debe cargar datos antes de poder modificar algo\n");
				}
			...
			case 5://
				...
				{
					puts("Debe cargar datos antes de poder eliminar algo\n");
				}
			...
			case 7://Ordenar
				if(ll_isEmpty(listaPasajeros)==RETORNOPOSITIVO)
				{
					menu_ordenarPasajero(listaPasajeros);
				}
				else
				{
					puts("Debe cargar datos antes de poder imprimir algo\n");
			...
			case 11:
				if(ll_isEmpty(listaPasajeros)==RETORNOPOSITIVO)
				{
					menu_filtroPorTipoPasajero(listaPasajeros);
			...
			case 12:
				if(ll_isEmpty(listaPasajeros)==RETORNOPOSITIVO)
				{
					menu_armaListasPorCodigoPasajero(listaPasajeros);
				}
				else
				{
					puts("se deben cargar pasajeros primero");
			...
			case 13:
				if(ll_isEmpty(listaPasajeros)==RETORNOPOSITIVO)
				{
					menu_calculaMillas(listaPasajeros);
				}
				else
				{
					puts("se deben cargar pasajeros primero");
